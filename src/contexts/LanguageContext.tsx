...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Where Vision Meets Precision',
  ...
  ar: {
    ...
    'hero.subtitle': 'حيث تلتقي الرؤية بالدقة',
    ...
    'about.description': 'تريس ديزاينز هي شركة استشارات تصميم وهندسة رائدة متخصصة في إنشاء مساحات استثنائية. يجمع فريقنا متعدد التخصصات بين الإبداع والخبرة التقنية لتقديم مشاريع تفوق التوقعات.',
    'about.mission.title': 'مهمتنا',
    'about.mission': 'تحويل الرؤى المعمارية إلى واقع من خلال حلول تصميم مبتكرة واهتمام دقيق بالتفاصيل.',
    'about.vision.title': 'رؤيتنا',
    'about.vision': 'أن نكون الخيار الأول لخدمات التصميم والهندسة الشاملة في المنطقة.',
    'about.team.title': 'فريق الخبراء',
    'about.team': 'يعمل فريقنا من المهندسين المعماريين والمهندسين والمصممين بشكل تعاوني لتحقيق رؤيتك.',
